...
(function (window, document, undefined)
{
    ...
    function publishExternalAPI(angular)
    {
        extend(angular, {
            ...
            'inputType': inputType // LF Helen: added this to use it outside of angular.
        });
    ...
    LocationHashbangInHtml5Url.prototype =
      ...
      LocationHtml5Url.prototype = {
          ...
          url: function (url, replace)
          {
              ...
              if (match[1]) this.path(match[1]);// LF: ugh, I had to do this to make it work. HACK: might look back at this and see if theres another way. Right now its decoding my encoded URL. I'm not sure what the reasoning behind it is.
                ...
                return function ($scope, $element, $attr)
                {
                    ...
                    $scope.$watchCollection(rhs, function ngRepeatAction(collection)
                    {
                        ...
                        } else
                        {
                            ...
                            //collectionKeys.sort(); // LF Helen: Yea... I'm changing the angular source code because this is stupid and I don't see a reason to make an ugly workaround outside of the code =.=. 
                        }
